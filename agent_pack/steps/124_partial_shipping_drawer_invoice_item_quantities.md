# Step 124: Partial Shipping Drawer by Invoice Item Quantities

## Objective

Ensure shipment creation from invoice uses selected invoice items and quantities with remaining unshipped validation in UI and API.
