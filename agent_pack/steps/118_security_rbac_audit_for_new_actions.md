# 118 — Security/RBAC Audit for New Actions

## الهدف
راجع الصلاحيات لكل الإجراءات الجديدة.

المطلوب:
- payments/supply/returns/shipping/exports/finance/inventory/actions.
- audit log لكل action مهم.
- API guards.
- menu/action visibility.
- super admin فقط البداية الأساسية.

قبول الخطوة:
- لا action حساس بدون permission.
