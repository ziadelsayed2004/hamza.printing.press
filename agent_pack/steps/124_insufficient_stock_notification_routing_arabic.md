# Step 124: Insufficient Stock Notification Routing + Arabic Copy

## Objective

Fix insufficient stock notification generation, display, Arabic text, severity, dedupe, and preview routing. Example: Insufficient stock for product must route to the product/inventory context and optionally the invoice that requested the unavailable quantity.
