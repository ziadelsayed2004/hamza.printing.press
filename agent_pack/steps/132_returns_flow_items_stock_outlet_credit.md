# Step 132: Returns Flow: Items, Stock, Outlet Credit

## Objective

Implement/verify returns from invoice item quantities. Return increases stock when appropriate, creates return balance/credit for the outlet, affects outlet limit/statement, and records reason, user, timestamp, and audit history.
