# 114 — Author + Outlet Accounts Scope Final

## الهدف
ثبت حسابات المؤلفين والمنافذ.

المطلوب:
- المؤلف يرى كتبه وفواتير تحتوي كتبه فقط.
- المنفذ يرى فواتيره وأرصدته وشحناته ومسترجعاته فقط.
- RBAC + row-level scoping.
- UI menu حسب الدور.

قبول الخطوة:
- لا leakage بين بيانات المنافذ/المؤلفين.
