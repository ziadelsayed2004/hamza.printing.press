# 106 — Partial Shipping by Invoice Items Final Logic

## الهدف
أكمل الشحن الجزئي حسب بنود الفاتورة.

المطلوب:
- endpoint يحسب remaining shippable per invoice item.
- UI يختار invoice -> item quantities.
- منع الكمية الزائدة.
- status invoice: not_shipped/pending, partially_shipped, shipped.
- shipment history واضح.
- action من الفاتورة ومن شاشة الشحن.

قبول الخطوة:
- يمكن شحن جزء من الفاتورة بدقة.
- تكرار الشحن لا يتجاوز الكميات.
