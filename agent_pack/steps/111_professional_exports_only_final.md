# 111 — Professional Exports Only Final

## الهدف
نظف التصدير وامنع الاستيراد.

المطلوب:
- حذف import routes/ui/schema بقايا.
- exports عربية احترافية: فواتير، مالية، مسترجعات، مخزون، منافذ، كتب، مؤلفين، شحن.
- كل export EGP/Egypt timezone.
- permissions واضحة.

قبول الخطوة:
- لا Import ظاهر أو فعال.
- exports جاهزة للعميل.
