...
## Goal
Audit the current repository, detect framework, database, routes, views, static assets, package scripts, deployment assumptions, and risks. Produce a factual audit report only; do not refactor yet.
...
8. Write a report in `agent_pack/reports/001_repo_reality_audit_REPORT.md`.
