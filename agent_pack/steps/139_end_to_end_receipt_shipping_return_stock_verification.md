# Step 139: E2E Verification: Receipt + Shipping + Return + Stock

## Objective

Create/run full chain verification: outlet -> invoice -> partial payment receipt -> receipt review -> partial shipment -> return -> stock update -> outlet balance -> notification -> export.
