# Step 137: Permissions Audit for Receipts/Returns/Shipping

## Objective

Add/verify RBAC for receipt upload/review/approve/reject, payments, returns, partial shipping, inventory receipts, outlet statements, and notification ignore/preview. Author/outlet users must only see scoped data.
