# 099 — RTL Fields Labels Alignment Global Fix

## الهدف
صلح مشكلة النصوص والحقول التي أصبحت شمال أو لازقة ومقطوعة.

المطلوب:
- كل MUI TextField/Input/Select/Autocomplete يكون RTL افتراضيًا.
- label فوق الحقل أو بشكل واضح غير مقصوص.
- helper/error أسفل الحقل.
- numeric technical values فقط يمكن أن تكون LTR داخل القيمة.
- أصلح pages/forms المتأثرة: Products, Outlets, OutletTypes, Authors, Invoices, Payments, Finance, Inventory, Shipments, Reports.

قبول الخطوة:
- لا يوجد label مقصوص.
- لا يوجد نص عربي aligned-left إلا لو justified تقنيًا.
- كل forms responsive.
