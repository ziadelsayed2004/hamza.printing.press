# Step 123: Home Notifications Actions: Preview + Ignore

## Objective

Replace the old/problematic notification action wording such as حل المشكلة with exactly two clear actions: تجاهل and معاينة. Ignoring must dismiss or mark notification as ignored; preview must route to the relevant module/entity with context.
