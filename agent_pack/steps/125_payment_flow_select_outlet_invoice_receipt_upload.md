# Step 125: Payment Flow: Select Outlet + Invoice + Receipt Upload

## Objective

Build/repair a payment creation flow where the user first selects an outlet, then sees that outlet invoices, chooses one invoice, enters paid amount, payment date/method, and uploads a receipt/proof attachment for every payment operation.
