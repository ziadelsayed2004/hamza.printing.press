# Step 129: MUI Deprecated Props + DOM Leak Cleanup

## Objective

Remove remaining deprecated props leaking to DOM, including InputProps/inputProps/InputLabelProps, and migrate to slotProps or CSS classes safely.
