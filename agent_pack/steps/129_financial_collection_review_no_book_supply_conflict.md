# Step 129: Financial Collection Review Without Book-Supply Conflict

## Objective

Keep financial collection/remittance separate from inventory receipts. Payment may be paid-only or paid-and-remitted/reviewed depending the business fields, but this must never be confused with book inventory receipt/supply.
