# 101 — Unified Side Drawers/Dialogs for All Entities

## الهدف
وحّد شكل side drawers والdialogs.

المطلوب:
- EntityDrawer component يدعم: size, title, subtitle, sections, sticky footer, loading, error.
- طبق نفس الشكل على إنشاء/تعديل: كتاب، مؤلف، منفذ، فئة منفذ، واردات، شحن، استرجاع، دفع/توريد.
- Dialogs للتأكيد فقط، وليس forms كبيرة.
- لا تستخدم `sx`/inline داخل drawer content إلا ديون مؤقتة موثقة.

قبول الخطوة:
- كل drawers بنفس المسافات والأبعاد.
- footer ثابت.
- fields لا تتزاحم.
