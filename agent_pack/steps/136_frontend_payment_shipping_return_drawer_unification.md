# Step 136: Frontend Drawer Unification: Payment/Shipping/Return

## Objective

Unify Payment, Receipt Review, Partial Shipping, Return, Inventory Receipt, Book, Outlet, and Outlet Type drawers under the same EntityDrawer/design contract with RTL alignment, spacing, sticky footer, no inline style, no !important.
