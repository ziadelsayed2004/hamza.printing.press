# Step 037: Reports Exports Ui

## Goal
Build dashboard/reports/excel/pdf export UI with cards, charts, filters, and permission-aware actions.
...
8. Write a report in `agent_pack/reports/037_reports_exports_ui_REPORT.md`.
