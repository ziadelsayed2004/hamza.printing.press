# Step 130: Invoice List Actions: Pay/Receipt, Ship, Return

## Objective

From the invoices list/details allow direct actions: record payment with receipt, mark/update payment state according to rules, create partial shipment, create return, export/print. Actions must respect permissions and refresh balances/notifications immediately.
