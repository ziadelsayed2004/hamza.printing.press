# Step 128: Final Payment Status: Deferred / Partial / Full

## Objective

Make the final payment model exactly three business states: مؤجل كلياً, مدفوع جزئياً, مدفوع كلياً. Remove installment wording/logic from backend, frontend, validation, exports, tests, docs, and UI filters.
