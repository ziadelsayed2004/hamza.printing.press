# Step 127: Partial Payment Receipts + History

## Objective

Support multiple partial payments per invoice without installments. Each payment has its own receipt, status, audit trail, and balance effect. The invoice remains partially paid until cumulative approved payments reach invoice total.
