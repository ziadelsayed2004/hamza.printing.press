# Step 133: Outlet Statement: Balances, Returns, Receipts

## Objective

Rebuild outlet statement logic to show invoices, payments with receipts, pending receivable, collected, reviewed/remitted if applicable, return balance, net balance, and credit/limit impact in EGP and Egypt timezone.
