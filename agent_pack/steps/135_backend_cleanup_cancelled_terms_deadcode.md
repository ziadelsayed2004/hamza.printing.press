# Step 135: Backend Cleanup: Cancelled Terms + Dead Code

## Objective

Deep-clean backend routes, services, schemas, validators, tests, exports, and docs from cancelled imports/installments and confusing supply terminology. Keep legacy useful features, improve them, and remove only explicitly cancelled/dead code.
