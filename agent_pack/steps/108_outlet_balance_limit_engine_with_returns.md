# 108 — Outlet Balance + Limit Engine With Returns

## الهدف
اضبط حسابات المنفذ والليميت.

المطلوب:
- API statement للمنفذ: invoices, payments, supplied, unsupplied, pending, returns, net exposure.
- limit calculation يستخدم return balance.
- notifications عند تجاوز limit.
- outlet account يرى فواتيره/أرصدته/شحناته/مسترجعاته فقط.

قبول الخطوة:
- الحسابات متسقة في dashboard/reports/outlet statement.
