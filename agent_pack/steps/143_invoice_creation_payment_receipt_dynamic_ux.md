# Step 143: Invoice Creation + Payment Receipt Dynamic UX

## Objective

Polish invoice creation UX: if user chooses full/partial paid at creation, require payment details and optional/required receipt according to final rule, update totals live, prevent invalid amounts, show outlet balance before save.
