# Step 141: Notification Preview Routes Smoke Matrix

## Objective

Build a smoke matrix for every notification type with preview target routes and ignored states. Include insufficient stock, low stock, overdue receivable, unreviewed receipt, return created, partial shipment, outlet limit exceeded.
