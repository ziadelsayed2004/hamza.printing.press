# Step 121: Business Terms: Inventory Receipts Are Stock Only

## Objective

Separate book supply/receipts (واردات الكتب/استلام كتب) from all financial collection/remittance concepts. Rename labels, API meanings, docs, and UI copy so inventory receipts only increase/decrease stock and never affect balances, paid amounts, collected cash, remittance, or outlet limits.
