# 105 — Payment Supply/Remittance UI + Permissions

## الهدف
أكمل UI التوريد والتحصيل.

المطلوب:
- شاشة تعرض الدفعات غير الموردة.
- bulk supply للدفعات المحددة.
- reverse supply بصلاحية أعلى إن لزم.
- filters: outlet, date, supplied/not_supplied, invoice.
- permissions: payments.record, payments.supply, payments.reverse, finance.view.

قبول الخطوة:
- المستخدم المالي يقدر يعرف المدفوع والمورد وغير المورد بوضوح.
