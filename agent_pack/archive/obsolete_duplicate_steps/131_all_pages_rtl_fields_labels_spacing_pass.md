# Step 131: All Pages RTL Fields/Labels/Spacing Pass

## Objective

Pass through every page and form field to fix right alignment, label notch, responsive field width, and mobile layout.
