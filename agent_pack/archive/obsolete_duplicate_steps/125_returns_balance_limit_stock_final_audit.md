# Step 125: Returns Balance/Limit/Stock Final Audit

## Objective

Audit and fix returns so return balance, outlet limit, stock ledger, statements, reports, notifications, and permissions are fully linked.
