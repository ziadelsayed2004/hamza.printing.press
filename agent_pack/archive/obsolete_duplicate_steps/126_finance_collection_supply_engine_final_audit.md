# Step 126: Finance Collection/Supply Engine Final Audit

## Objective

Audit the finance engine for pending receivable, collected, supplied, unsupplied, return balance and invoice payment statuses.
