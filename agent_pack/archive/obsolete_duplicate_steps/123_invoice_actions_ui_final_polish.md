# Step 123: Invoice Actions UI Final Polish

## Objective

Polish invoice list/details actions for pay, mark paid, supply/remit, partial ship, return, export/print with correct permissions and spacing.
